...
[![GitHub Build Status](https://github.com/cisagov/freeipa-client-packer/workflows/build/badge.svg)](https://github.com/cisagov/freeipa-client-packer/actions)
...
best way to make `freeipa-client-install` run at first boot is to use
...
[repository's secrets](https://github.com/cisagov/freeipa-client-packer/settings/secrets)
...
```console
[test-freeipa-client-packer]
aws_access_key_id = AKIAXXXXXXXXXXXXXXXX
aws_secret_access_key = XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX

[cool-images-ec2amicreate-freeipa-client-packer]
role_arn = arn:aws:iam::111111111111:role/EC2AMICreate-test-freeipa-client-packer
source_profile = test-freeipa-client-packer
...
AWS_PROFILE=cool-images-ec2amicreate-freeipa-client-packer packer build --timestamp-ui src/packer.json
```
